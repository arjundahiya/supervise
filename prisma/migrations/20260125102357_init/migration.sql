/*
  ...
  - You are about to drop the `_SupervisionStudents` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "SwapRequest" DROP CONSTRAINT "SwapRequest_supervisionId_fkey";

-- DropForeignKey
ALTER TABLE "SwapRequest" DROP CONSTRAINT "SwapRequest_targetId_fkey";

-- DropForeignKey
ALTER TABLE "_SupervisionStudents" DROP CONSTRAINT "_SupervisionStudents_A_fkey";
...
-- DropTable
DROP TABLE "_SupervisionStudents";
